...
export const audiences: Audience[] = [
	{
		...
		body: "You've spent years making other people's ideas real. Come make your own. Cursor South Africa will show you how far you can get in an afternoon.",
	},
	{
		id: 'founders',
		title: 'Founders',
		body: 'Stop waiting on a dev queue. Build the prototype yourself, this week, and put it in front of users on Monday. No technical co-founder required.',
	},
	{
		id: 'developers',
		title: 'Developers',
		body: 'You already ship. Now ship 3x faster and trade notes on Cursor workflows with people pushing the tool as hard as you are.',
	},
	{
		id: 'vibe-coders',
